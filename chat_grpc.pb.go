...
func (x *chatSendMessageClient) Send(m *FromClient) error {
	return x.ClientStream.SendMsg(m)
}

func (x *chatSendMessageClient) Recv() (*FromServer, error) {
	m := new(FromServer)
...
func (x *chatSendMessageServer) Send(m *FromServer) error {
	return x.ServerStream.SendMsg(m)
}

func (x *chatSendMessageServer) Recv() (*FromClient, error) {
	m := new(FromClient)
